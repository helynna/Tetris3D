...
#include "../../tetris3D/camerawidget.h"
...
QT_MOC_LITERAL(1, 13, 3), // "rot"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "acceleration"
QT_MOC_LITERAL(4, 31, 7), // "leftsig"
QT_MOC_LITERAL(5, 39, 8), // "rightsig"
QT_MOC_LITERAL(6, 48, 7) // "newgame"

    },
    "CameraWidget\0rot\0\0acceleration\0leftsig\0"
    "rightsig\0newgame"
};
...
void CameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->rot(); break;
        case 1: _t->acceleration(); break;
        case 2: _t->leftsig(); break;
        case 3: _t->rightsig(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::rot)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CameraWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::acceleration)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (CameraWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::leftsig)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (CameraWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::rightsig)) {
                *result = 3;
                return;
            }
        }
        {
            typedef void (CameraWidget::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CameraWidget::newgame)) {
                *result = 4;
                return;
            }
        }
...
const QMetaObject CameraWidget::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_CameraWidget.data,
...
// SIGNAL 0
void CameraWidget::rot()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CameraWidget::acceleration()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void CameraWidget::leftsig()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void CameraWidget::rightsig()
{
    QMetaObject::activate(this, &staticMetaObject, 3, nullptr);
}

// SIGNAL 4
void CameraWidget::newgame()
{
